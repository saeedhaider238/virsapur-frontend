...
const AboutUs = () => {
    ...
    return (
        <Grid container sx={{ padding: '180px 20px 70px 20px', display: 'flex', justifyContent: 'space-between', maxWidth: '1200px', alignItems: 'center', flexWrap: 'wrap-reverse'}} spacing={!isSmallScreen ? 6 : 0} >
