...
const GetInTouch = () => {
    ...
    return (
        <Grid container sx={{ justifyContent: 'center', backgroundImage: `url(${getInTouchBackground})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center bottom', width: '100%', marginTop: '150px' }}>
            <Grid container sx={{ width: '100%', maxWidth: '1200px', padding: '100px 20px 250px 20px' }} >
