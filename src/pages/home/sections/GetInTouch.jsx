...
const GetInTouch = () => {
    ...
    return (
        <Grid container sx={{ justifyContent: 'center', backgroundImage: `url(${getInTouchBackground})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center bottom', position: 'sticky', top: 0, left: 0, width: '100%' }}>
            <Grid container sx={{ width: '100%', maxWidth: '1200px', padding: '250px 20px 250px 20px' }} >
