...
const AboutUs = ({ scrollY }) => {
  ...
  return (
    <Grid container sx={{ justifyContent: 'center', width: '100%', backgroundColor: 'white', position: 'relative', zIndex: 29, marginTop: '50px' }}>
      <Grid container sx={{ minHeight: '100vh', padding: '0px 20px 0px 20px', display: 'flex', justifyContent: 'space-between', maxWidth: '1200px', alignItems: !isSmallScreen ? 'center' : 'flex-start' }} spacing={6} >
